...
exports.create = (req, res) => {
    const { productName, price, thumbnail, image, salePercentage, quantity, description, createdUser, category } = req.body;
    ...
    fs.readFile(dataFile, "utf-8", (readErr, data) => {
        ...
        const newObj = { id: uuid.v4(), categoryId: uuid.v4(), productName, price, thumbnail, image, salePercentage, quantity, description, createdUser, category };
    ...
    fs.readFile(dataFile, "utf-8", (readErr, data) => {
        ...
        const updateData = parsedData.map((cateObj) => {
            if (cateObj.id == id) {
                return {
                    ...cateObj,
                    productName, price, thumbnail, image, salePercentage, quantity, description, createdUser, category
                }
            }
            else {
                return cateObj;
